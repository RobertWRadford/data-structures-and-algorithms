...
const sortBackwards = (arr) => {
  //w3schools https://www.w3schools.com/js/tryit.asp?filename=tryjs_array_sort3 example
...
const alphabetizeBetter = (arr) => {
  arr.sort(function(a, b){return(a.toUpperCase() > b.toUpperCase() ? 1:-1)});
  return arr;
};
...
const sortPeople = (arr) => {
  arr.sort(function(a,b){return (a.lastName > b.lastName ? 1:-1) })
  return arr;
};
...
const sortMeetingsByDay = (arr) => {
  arr.sort(function(a,b){
    ...
    return valueDict[a.dayOfWeek] - valueDict[b.dayOfWeek];
  });
  return arr;
};
