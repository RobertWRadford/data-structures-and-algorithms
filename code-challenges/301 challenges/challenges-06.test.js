...
const templatingWithMustache = () => {
  ...
  characters.forEach( person => {
    ...
    let templateHtml = Mustache.render($getTemplate, person);
    characterTemplates.push(templateHtml);
  });
...
------------------------------------------------------------------------------------------------ */
// really strongly dislike the way this question is written. I thought it meant how many value type characters were in the array. e.g. ['apple', 'banana'] returns 5+6=11
// I only answered this correctly by reading the input, the expected result, and counting things until I figured out what was 26
