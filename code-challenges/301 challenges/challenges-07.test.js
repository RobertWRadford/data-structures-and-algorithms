...
------------------------------------------------------------------------------------------------ */
function handleCharMap(char){
  return char.charCodeAt(0);
}

const charCode = (arr) => {
  return arr.map(handleCharMap);
};
...
const evenOdd = (arr) => {
  return arr.map(handleEvenOddMap);
};
...
function handleAbilityMap(dict){
  return dict.ability.name;
}

const extractAbilities = (arr) => {
  return arr.map(handleAbilityMap);
};
...
function handleStatsMap(dict){
  let statObj = {};
  statObj.name = dict.stat.name;
  statObj.total = dict.effort + dict.baseStat;
  return statObj;
}

const extractStats = (arr) => {
  return arr.map(handleStatsMap);
};
